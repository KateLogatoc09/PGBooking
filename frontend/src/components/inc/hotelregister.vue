                ...
                <div class="row g-5 align-items-center">
                    <div class="col-md-6 text-white" id="classy2">
                        <div class="row g-3">
                            <div class="col-md-12" id="color">
                                ...
                                <div class="col-md-12" id="color">
                                    <div class="form-floating">
                                        <input type="password" minlength="8" class="form-control bg-transparent" id="c_password" placeholder="Confirm Password" required>
                                        <label for="confirmpassword">Confirm Password</label>
                                    </div>
                                </div>
                                <div class="col-md-12"  id="color">
                                    <div class="form-floating">
                                        <input type="tel" maxlength="11" pattern="[0][9][0-9]{9}" class="form-control bg-transparent" id="number" placeholder="Phone Number (09XXXXXXXXX)" required>
                    ...
                    <div class="col-md-6" id="classy2">
                            <div class="row g-3">
                                <div class="col-md-12" id="color">
                                    <div class="form-floating">
                                        <input type="text" class="form-control bg-transparent" id="insurance" placeholder="Insurance" required>
                                        <label for="insurance">Upload a scanned copy of Insurance</label>
                                    </div>
                                </div>
                                <div class="col-md-12" id="color">
                                    <div class="form-floating">
                                        <input type="text" class="form-control bg-transparent" id="assessment" placeholder="Assessment" required>
                                        <label for="assessment">Upload a scanned copy of Self-Assessment Form</label>
                                    </div>
                                </div>
                                <div class="col-md-12" id="color">
                                    <div class="form-floating">
                                        <input type="text" class="form-control bg-transparent" id="application" placeholder="Application" required>
                                        <label for="application">Upload a scanned copy of Application Form</label>
                                    </div>
                                </div>
                                <div class="col-md-12" id="color">
                                    <div class="form-floating">
                                        <input type="text" class="form-control bg-transparent" id="intent" placeholder="Intent" required>
                                        <label for="intent">Upload a scanned copy of Letter of Intent to Operate</label>
                                    </div>
                                </div>                              
                                <div class="col-md-12" id="color">
                                    <div class="form-floating">
                                        <input type="text" class="form-control bg-transparent" id="discharge" placeholder="Discharge" required>
                                        <label for="discharge">Upload a scanned copy of Discharge Permit</label>
                                    </div>
                                </div>
                                <div class="col-md-12" id="color">
                                    <div class="form-floating">
                                        <input type="text" class="form-control bg-transparent" id="logo" placeholder="Logo" required>
                                        <label for="logo">Upload logo of business</label>
                                    </div>
                                </div>
                                <div class="col-md-12" id="color">
                                    <div class="form-floating">
                                        <input type="text" class="form-control bg-transparent" id="permit" placeholder="Permit" required>
